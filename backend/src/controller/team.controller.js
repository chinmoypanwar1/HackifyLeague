...
const addMemberToTeam = asyncHandler(async (req, res) => {
    ...
    console.log(team.members.find((member) => member.user.toString() === user._id.toString()))
...
export { createTeam, addMemberToTeam, removeMemberfromTeam }
